...
\begin{lstlisting}
wget https://github.com/VishalBurra27/randomvar/blob/main/code/q1.1.c
wget https://github.com/VishalBurra27/randomvar/blob/main/code/coeffs.h
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/VishalBurra27/randomvar/blob/main/code/q1.2.py
\end{lstlisting}
...
\solution Download the following files and execute the  C program.
\begin{lstlisting}
wget https://github.com/VishalBurra27/randomvar/blob/main/code/q1.4.c
wget https://github.com/VishalBurra27/randomvar/blob/main/code/coeffs.h
\end{lstlisting}
Download the above files and execute the following commands
\begin{lstlisting}
...
\solution Download the following files and execute the  C program.
\begin{lstlisting}
wget https://github.com/VishalBurra27/randomvar/blob/main/code/q2.1.c
wget https://github.com/VishalBurra27/randomvar/blob/main/code/coeffs.h
\end{lstlisting}
Download the above files and execute the following commands
\begin{lstlisting}
...
\begin{lstlisting}
wget https://github.com/VishalBurra27/randomvar/blob/main/code/q2.2.py
\end{lstlisting}
...
\begin{lstlisting}
wget https://github.com/VishalBurra27/randomvar/blob/main/code/q2.3.py
\end{lstlisting}
...
\solution Download the following files and execute the  C program.
\begin{lstlisting}
wget https://github.com/VishalBurra27/randomvar/blob/main/code/q2.4.c
wget https://github.com/VishalBurra27/randomvar/blob/main/code/coeffs.h
\end{lstlisting}
Download the above files and execute the following commands
\begin{lstlisting}
...
\solution Download the following files and execute the  C program.
\begin{lstlisting}
wget https://github.com/VishalBurra27/randomvar/blob/main/code/q3.1.c
wget https://github.com/VishalBurra27/randomvar/blob/main/code/coeffs.h
\end{lstlisting}
Download the above files and execute the following commands
\begin{lstlisting}
...
\begin{lstlisting}
wget https://github.com/VishalBurra27/randomvar/blob/main/code/q3.1.py
\end{lstlisting}
...
\item Generate
	...
	\end{align}
\solution
The c code for generating T is at :
\begin{lstlisting}

wget https://github.com/VishalBurra27/randomvar/blob/main/code/q4.1.c
...
./a.out
\end{lstlisting}
This generates a file named "td.dat"
\item Find the CDF of $T$.

\solution
The Python code for the plot is :
\begin{lstlisting}
$ wget https://github.com/VishalBurra27/randomvar/blob/main/code/q4.2.py
\end{lstlisting}
...
\end{lstlisting}
\begin{figure}[!htb]
	\includegraphics[width=\columnwidth]{./figs/q4.2.png}
	\caption{The CDF of $T$}
	\label{fig:tri-cdf}
\end{figure}
\item Find the PDF of $T$.
	\begin{figure}
		\includegraphics[width=\columnwidth]{./figs/q4.3.png}
		\caption{The PDF of $T$}
		\label{fig:tri-pdf}
	\end{figure}
	
\solution
The Python code for the figure is available at : 
\begin{lstlisting}
$ wget https://github.com/VishalBurra27/randomvar/blob/main/code/q4.3.py
\end{lstlisting}
and run using
\begin{lstlisting}
$ python3 q4.3.py
...
We have three cases:
		\begin{enumerate}
			\item $t < 0$: Using equation \eqref{unicdf} $F_T(t) = 0$.
